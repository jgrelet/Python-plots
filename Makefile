...
SECT_CTD = netcdf/OS_PIRATA-FR31_CTD.nc -t CTD -s --append 1N-10W_10S_10W -k PRES TEMP --xaxis LATITUDE -l 5 28 --yscale 0 250 250 2000 --xinterp 24 --yinterp 10 --clevels=30 --autoscale 0 30
SECT2_CTD = netcdf/OS_PIRATA-FR31_CTD.nc -t CTD -s --append point-fixe_0-10W -k PRES TEMP --xaxis TIME -l 33 49 --yscale 0 200 --xinterp 17 --yinterp 10 --clevels=30 --autoscale 0 30
SECT3_CTD = netcdf/OS_PIRATA-FR31_CTD.nc -t CTD -s --append point-fixe_0-23W -k PRES TEMP --xaxis TIME -l 54 69 --yscale 0 200 --xinterp 17 --yinterp 10 --clevels=30 --autoscale 0 30
