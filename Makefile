...
SECT3_CTD = netcdf/OS_PIRATA-FR31_CTD.nc -t CTD -s --append point-fixe_0-23W -k PRES TEMP --xaxis TIME -l 54 69 --yscale 0 200 --xinterp 17 --yinterp 20 --clevels=30 --autoscale 0 30
